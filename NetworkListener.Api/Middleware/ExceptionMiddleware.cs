...
namespace NetworkListener.Api.Middleware
{
    ...
    public class ExceptionMiddleware
    {
        ...
        private static Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            else if (exception is CustomAggregateException)
            {
                if (exception is CustomAggregateException customException)
                {
                    message = customException.Content;
                    statusCode = customException.StatusCode;
                    if (customException.Exception != null)
                    {
